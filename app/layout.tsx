...
export const metadata: Metadata = {
  title: "Asha Cobb-Jones - UX Designer",
  description: "UX Designer Portfolio - Where nostalgia meets modern design",
  generator: "v0.app",
}
  ...
  return (
    <html lang="en">
      <body 
        ...
        style={{
          backgroundImage: "url('https://i.imgur.com/Gy3XT9z.png')",
